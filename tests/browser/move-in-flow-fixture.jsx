...
createRoot(document.getElementById("root")).render(<main><ReservationMoveInConfirmation reservationId="booking-55" customerName="Synthetic Customer" unitNumber="55" readiness={readiness} progress={progress} canRecordPayment canReviewIdentity canReviewPhoto onBack={() => { location.hash = "select-unit"; }} /></main>);
