...
- Consent text, the checkbox wording, policy hash/version, verified customer identity and consent time are recorded. The full accepted policy is retained in each submission audit even after a replacement. New versions erase the prior ciphertext and invalidate approval. An unticked checkbox cannot submit.
