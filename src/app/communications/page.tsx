...
export default async function CommunicationsPage() {
  ...
  return <div className="page-stack">
    ...
    <section className="summary-strip"><div className="summary-cell"><span>WhatsApp attempts</span><strong>{logs.length}</strong></div><div className="summary-cell"><span>Awaiting confirmation</span><strong>{pending}</strong></div><div className="summary-cell"><span>Delivered / read</span><strong>{logs.filter((item) => item.deliveredAt).length}</strong></div><div className="summary-cell"><span>Failed</span><strong>{failed}</strong></div></section>
