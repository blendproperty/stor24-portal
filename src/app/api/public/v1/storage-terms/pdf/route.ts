...
export async function GET(request: Request) {
  ...
  const bytes = await renderSignedLeasePdf({ unsigned: true, content: storageTermsText(), reference: STORAGE_TERMS_VERSION, paymentMethod: "", signerName: "", signedAt: new Date("2026-09-22T00:00:00Z"), sha256: "" });
