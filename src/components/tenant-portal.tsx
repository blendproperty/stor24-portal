  ...
  return <main className="tenant-portal">
    ...
    <div className="tenant-body">
      {checking ? <p role="status">Opening your secure space…</p> : !data ? <div className="tenant-entry">
        ...
        {selectedUnit && <section className="tenant-card"><h2>Facial access</h2><p>{selectedUnit.accessState === "ACTIVE" ? "Access is recorded as active. Contact the store if entry does not work." : "Facial access is not active. It requires a completed move-in and separate staff enrolment and confirmation."}</p></section>}
